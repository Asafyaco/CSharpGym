...
namespace CSharpGym
{
    public class Meet4_Linq_1   // LINQ VS SQL requests
    {
        public void Run1()
        {
            int[] nums = { 1, 2, 3, 4, 5, 6, -12, -90, 45, 45, 2, 32334, 34, 345, 345345 };

            //SQL requests - Structure

            // select *  || את מה בוחרים
            // from tbl  || מאיפה הנתונים מגיעים
            // where || condition - תנאי
        ...
        public void Run2()
        {
            var list3 =
                ...
                select (x.ProductID, x.UnitPrice); // Tuple סגנון כתיבת
        }
        ...
        public void Run3()
        {
            ...
            var list4 = from n1 in num1
                        from n2 in num2
                        where n1 < n2
                        select(n1, n2); 
            
            var list5 = from n1 in num1
                        from x in ProductList
